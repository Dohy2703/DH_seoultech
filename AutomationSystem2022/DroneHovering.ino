/*
Gwanho Jung, Hyeonsu Jeon, Dohyeon Kim
...
int count = 0;
//ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡppm encoderㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ//
byte interruptPin = 2;
byte chAmount = 8;
...
const double DEG_PER_SEC = 32767 / 250;    // ang per sec
...
//ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡdual loop PIDㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
...
void loop()
{
  ...
  roll_target_angle = y_dot_output; 
  pitch_target_angle = x_dot_output;  
...
void initMPUSensor()
{
  ...
  Wire.write(0x6B);// MPU6050 commun    
  Wire.write(0x01);
...
void dualPID(float target_angle,
  ...
  stabilize_iterm += stabilize_ki * angle_error * dt; // stablize I term
